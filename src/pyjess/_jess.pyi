...
class Atom:
    ...
    def transform(self, matrix: Mat4) -> Atom: ...
...
class TemplateAtom:
    ...
    def dumps(self) -> str: ...
    def transform(self, matrix: Mat4) -> TemplateAtom: ...
...
class Template(Sequence[TemplateAtom]):
    ...
    def dump(self, file: TextIO) -> None: ...
    def dumps(self) -> str: ...
    def transform(self, matrix: Mat4) -> Template: ...
...
class Hit(Generic[_T]):
    ...
    @property
    def inverse_transformation(self) -> Mat4: ...
    @property
    def rmsd(self) -> float: ...
    @property

...
class Molecule(Sequence[Atom]):
    @classmethod
    def from_biopython(cls, structure: Union[Structure, Model], id: Optional[str] = None, depdate: Optional[str] = None, name: Optional[str] = None) -> Molecule: ...
    @classmethod
    def from_gemmi(cls, structure: gemmi.Structure) -> Molecule: ...
    @classmethod
    def from_biotite(cls, atom_array: biotite.structure.AtomArray, id: Optional[str] = None, depdate: Optional[str] = None, name: Optional[str] = None) -> Molecule: ...
    @classmethod
    def load(
        cls,
    ...
    def __init__(self, atoms: Sequence[Atom] = (), id: Optional[str] = None, depdate: Optional[str] = None, name: Optional[str] = None): ...
    ...
    @property
    def depdate(self) -> Optional[str]: ...
    @property
    def name(self) -> Optional[str]: ...
    def conserved(self: _SELF, cutoff: float = 0.0) -> _SELF: ...
    def copy(self) -> Molecule: ...
    def dumps(self, format: Literal["pdb"] = "pdb", write_id: bool = True) -> str: ...
    def dump(self, file: TextIO, format: Literal["pdb"] = "pdb", write_id: bool = True) -> None: ...
...
class Atom:
    ...
    def z(self) -> float: ...
    def copy(self) -> Atom: ...
    def dumps(self, format: Literal["pdb"]) -> str: ...
    def dump(self, file: TextIO, format: Literal["pdb"]) -> None: ...

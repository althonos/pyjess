...
class Molecule(Sequence[Atom]):
    ...
    @typing.overload
    def __getitem__(self, index: slice) -> Molecule: ...
    @typing.overload
    def __getitem__(self, index: Union[int, slice]) -> Union[Atom, Molecule]: ...
    @property
...
class Template(Sequence[TemplateAtom]):
    ...
    @typing.overload
    def __getitem__(self, index: slice) -> Template: ...
    @typing.overload
    def __getitem__(self, index: Union[int, slice]) -> Union[TemplateAtom, Template]: ...
    @property
    def id(self) -> str: ...
    @property

...
project = "pyjess"
author = re.match('(.*) <.*>', pyjess.__author__).group(1)
...
doc_lines = pyjess.__doc__.splitlines()
...
html_theme_options = {
    ...
    "icon_links": [
        ...
        {
            "name": "PyPI",
            "url": "https://pypi.org/project/pyjess",
    ...
    "switcher": {
        "json_url": "https://pyjess.readthedocs.io/en/latest/_static/switcher.json",
...
htmlhelp_basename = pyjess.__name__
